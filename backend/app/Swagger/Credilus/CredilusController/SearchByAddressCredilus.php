...
/**
 * @OA\Get(
 *     path="/api/v1/credilus/search/address",
 *     summary="Realiza a busca de dados de um cliente pelo endereço",
 *     description="Faz a busca de dados no credilus usando o endereço",
 *     tags={"Credilus"},
 *     operationId="addressCredilus",
 *     @OA\Parameter(
 *         name="state",
 *         in="query",
 ...
 *             @OA\Property(property="message", type="string", example="A client address not found")
 *         )
 *     ),
 *     security={{"bearerAuth": {}}}
 * )
