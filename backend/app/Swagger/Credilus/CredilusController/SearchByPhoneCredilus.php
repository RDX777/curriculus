...
/**
 * @OA\Get(
 *     path="/api/v1/credilus/search/phone/{phone}",
 *     summary="Realiza a busca de dados de um cliente pelo telefone",
 *     description="Faz a busca de dados no credilus usando o telefone do cliente",
 *     tags={"Credilus"},
 *     operationId="phoneCredilus",
 *     @OA\Parameter(
 *         name="phone",
 *         in="path",
 *         description="Telefone do cliente a ser buscado",
 *         required=true,
 *         @OA\Schema(
 *             type="string",
 *             example="99999999999"
 ...
 *             @OA\Property(property="message", type="string", example="A client phone not found")
 *         )
 *     ),
 *     security={{"bearerAuth": {}}}
 * )
