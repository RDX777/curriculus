...
/**
 * @OA\Get(
 *     path="/api/v1/credilus/search/cpf/{cpf}",
 *     summary="Realiza a busca de dados de um cliente pelo CPF",
 *     description="Faz a busca de dados no credilus usando o CPF do cliente",
 *     tags={"Credilus"},
 *     operationId="cpfCredilus",
 *     @OA\Parameter(
 *         name="cpf",
 *         in="path",
 ...
 *             @OA\Property(property="message", type="string", example="A client CPF not found")
 *         )
 *     ),
 *     security={{"bearerAuth": {}}}
 * )
