...
/**
 * @OA\Get(
 *     path="/api/v1/credilus/search/id/{id}",
 *     summary="Realiza a busca de dados de um cliente pelo ID",
 *     description="Faz a busca de dados no credilus usando o ID do registro do cliente",
 *     tags={"Credilus"},
 *     operationId="searchByIdCredilus",
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 *                     @OA\Property(property="NOME", type="string", example="Beterraba Pudim"),
 ...
 *                     @OA\Property(property="EMAILS", type="string", example="beterraba@example.com"),
 ...
 *                     @OA\Property(property="NOME", type="string", example="Pamonha Cômica"),
 *                 )
 *             )
 *         )
 *     ),
 ...
 *             @OA\Property(property="message", type="string", example="A client ID not found")
 *         )
 *     ),
 *     security={{"bearerAuth": {}}}
 * )
